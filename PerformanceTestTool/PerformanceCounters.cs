...
{
	public readonly List<PerformanceCounter> PerformanceCounterList;

	public PerformanceCounters(List<PerformanceCounter> performanceCounterList)
	{
		PerformanceCounterList = performanceCounterList;
	}
}
