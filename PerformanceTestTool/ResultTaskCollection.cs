...
public class ResultTaskCollection
{
	public List<ResultTask> Tasks = new List<ResultTask>();
	public string Description;
	public int PerformanceCountersSamplingInterval;
	public int Connections;
	public int TimeBetweenConnections;
	public int PerformanceCountersSamples;
	public string Mode;
